...
BEGIN
    ...
    INSERT INTO campaigns (email_account_id, email_template_id, name, subject, from_email_address, reply_to_email_address)
    VALUES (v_email_account_id, v_email_template_id, 'Sample Campaign', 'Welcome to our site', 'your_email@zoho.com', 'your_email@zoho.com');
